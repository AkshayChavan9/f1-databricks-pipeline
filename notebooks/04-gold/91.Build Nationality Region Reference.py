...
# MAGIC %md
# MAGIC ### Create a dataframe with list of nationalities and corresponding geographic regions
...
# MAGIC %md
# MAGIC ###  Write the dataframe to the `gold` `ref_nationality_region` table
